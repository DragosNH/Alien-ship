...
const superiourPlateMat = new THREE.MeshNormalMaterial({
    color: 0xb9bbbe
});
...
const middlePlateMat = new THREE.MeshNormalMaterial({
    color: 0x939599
});
...
const inferiourPlateMat = new THREE.MeshNormalMaterial({
    color: 0x75777b
});
